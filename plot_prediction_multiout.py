...
#predictnpyfname = '/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_bitmask_dtypebool_patches_predict_UResNet152_size1by1_size1by3.npy'
t_str = 'MaskUint8'
...
#predictnpyfname = '/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_distancemapnormalized_dtypefloat32_patches_predict_UResNet152.npy'
#predictnpyfname = '/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_distancemapnormalized_dtypefloat32_patches_predict_UResNet152_size1by1_size1by3.npy'
#t_str = 'EDT'

## GaussianBlur
#inputnpyfname ='/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_DAPI_uint16touint8_normalizeandscale_dtypeuint8_patches.npy'
#targetnpyfname ='/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_gblurradius1_dtypefloat32_patches.npy'
#predictnpyfname = '/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_gblurradius1_dtypefloat32_patches_predict_UResNet152.npy'
#predictnpyfname ='/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_gblurradius1_dtypefloat32_patches_predict_UResNet152_size1by3_size1by1.npy'
#t_str = 'GBlur-Radius1'
...
# Mask+Outline Multiput
inputnpyfname ='/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_DAPI_uint16touint8_normalizeandscale_dtypeuint8_patches.npy'
targetnpyfname ='/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_bitmask_dtypebool_patches.npy'
predictnpyfname = '/gpfs/gsfs10/users/HiTIF/progs/dl_segmentation/segmentation_models/Sigal_WellE03/input_augmentedintensity_rotations/20180823_075547/WellE03_chunkindex_011_bitmask_dtypebool_patches_predict_UResNet152_size1by1_size1by3_mask_outline_multiloss_sigmoid.npy'
t_str = 'Mask+Outline'
...
if plotFlag : 
  ...
  #for i in range(imgs_train.shape[0]-1,-1,-1):
      ...
      mask_pre_1 = np.squeeze(imgs_mask_predict[i,:,:,0])
      mask_pre_1_amax = np.amax(mask_pre_1)
      mask_pre_1_amin = np.amin(mask_pre_1)
      mask_pre_2 = np.squeeze(imgs_mask_predict[i,:,:,1])
      mask_pre_2_amax = np.amax(mask_pre_2)
      mask_pre_2_amin = np.amin(mask_pre_2)
      ...
      imgplot = plt.imshow(mask_pre_1)
      imgplot.set_clim(mask_pre_1_amin, mask_pre_1_amax)
      a.set_title(t_str + ' Prediction : '+str(i))
      plt.colorbar(orientation ='horizontal')
      a = fig.add_subplot(1,5,4)
      imgplot = plt.imshow(mask_pre_2)
      imgplot.set_clim(mask_pre_2_amin, mask_pre_2_amax)
      a.set_title(t_str + ' Prediction : '+str(i))
      plt.colorbar(orientation ='horizontal')

      a = fig.add_subplot(1,5,5)
      diff_img = mask_pre_1-mask
